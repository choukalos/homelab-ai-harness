...
def build_document(req) -> Dict[str, Any]:
    ...
    from creative.layout.schemas import CreateLayoutRequest
    ...
    for zone_spec in req.zones:
        if zone_spec.content_type == "gen_image":
            ...
            from creative.layout.schemas import AddContentRequest
    ...
    # Step 3: Save HTML
    from creative.layout.schemas import SaveLayoutRequest
    ...
    if req.export_pdf:
        ...
        from creative.layout.schemas import ExportPdfRequest
