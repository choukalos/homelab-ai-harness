...
from core.config import MEDIA_OUTPUT_DIR, INTERNAL_BASE_URL, SEARXNG_BASE_URL
from core.llm import chat_completion_sync
from web_search.schemas import WebSearchRequest, SearchResult as WsSearchResult
from web_search.service import crawl_url as _crawl_url
from family_kb.schemas import SearchRequest
from family_kb.service import search_kb
from market_research.prompts import (
    prompt_kb_insights,
...
from market_research.schemas import Competitor, ComparisonVector
from market_research.schemas import CompetitorProfile, OpportunityFlag
...
def stage9_visual_planning(state: MarketResearchState) -> dict:
    ...
    from market_research.schemas import VisualAssetSpec
...
def stage10_report_assembly(state: MarketResearchState) -> dict:
    ...
    from layout.service import layout_create, layout_add_content, layout_render, layout_export_pdf, _layouts
    from charts.schemas import ChartConfig, ChartFormat
