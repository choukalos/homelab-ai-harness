...
from workflows.service import complete_step, fail_step
...
def register() -> None:
    ...
    """
    from market_research.service import (
        stage1_kb_lookup,
...
def _load_state(run: Any) -> Any:
    ...
    """
    from market_research.schemas import MarketResearchState
    ...
    for step in run.steps:
        ...
        if name == "stage1_kb_lookup":
            from market_research.schemas import KbLookupResult
