...
from infra.core.config import PUBLIC_BASE_URL
...
from research.web_search.service import run_research_brief
...
async def _handle_deep_research(req: SiriChatRequest) -> SiriChatResponse:
    ...
    from infra.core.config import HARNESS_API_KEY, INTERNAL_BASE_URL
...
async def _handle_update_presentation(req: SiriChatRequest) -> SiriChatResponse:
    ...
    import logging
    from infra.core.config import HARNESS_API_KEY, INTERNAL_BASE_URL
    from creative.presentation.prompts import UPDATE_INSTRUCTION_PROMPT
