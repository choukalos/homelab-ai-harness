...
from research.market_research.schemas import MarketResearchRequest, MarketResearchState
...
from infra.workflows.schemas import RunUpdateRequest, WorkflowRunResponse
...
def _ensure_workflow() -> str:
    ...
    """
    from infra.workflows.service import list_workflows, get_workflow
    from infra.workflows.schemas import WorkflowListFilters
...
def list_jobs(
    ...
    from infra.workflows.service import list_runs
