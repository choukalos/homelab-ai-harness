...
from infra.core.config import MEDIA_OUTPUT_DIR, INTERNAL_BASE_URL, PUBLIC_BASE_URL
from infra.core.security import require_harness_auth
from apps.demo_workflow.schemas import (
    AsyncTaskResponse,
    AsyncTaskStatus,
    DemoCreateRequest,
    DemoCreateResponse,
)
from apps.demo_workflow.service import (
    run_demo,
    resume_demo,
...
def run_demo_async(
    ...
    from apps.demo_workflow.tasks import generate_demo_task
