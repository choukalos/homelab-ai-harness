...
from apps.demo_workflow.service import ensure_checkpointer_tables
    ...
    *,
    ...
    try:
        ...
        async def _run():
            ...
            from apps.demo_workflow.schemas import DemoCreateRequest
            from apps.demo_workflow.service import run_demo
