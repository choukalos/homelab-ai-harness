...
------
1. **Worker** — ``celery -A infra.core.celery_app.celery worker ...``
2. **Beat**   — ``celery beat -A infra.core.celery_app.celery -S redbeat.RedBeatScheduler ...``
...
# Module-level singleton so any ``from infra.core.celery_app import celery`` works
celery = make_celery()
